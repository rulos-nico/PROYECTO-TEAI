...
\title[Modelamiento DES]{Modelamiento de la Planta Industrial Distibuidora}
...
\begin{itemize}
    \item La distribuición de piezas debe ser rotativa entre cada una dependiendo por la primera pieza entrante.
\end{itemize}
\textbf{3.Mantenimiento}
\begin{itemize}
    \item En el proceso de entrega de elemento se da prioridad a la reparación por sobre la entrega, en el orden definido por la mesa distribuidora
\end{itemize}
\end{frame}
